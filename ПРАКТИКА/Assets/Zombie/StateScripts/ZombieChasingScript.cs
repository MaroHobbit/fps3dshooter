...
public class ZombieChasingScript : StateMachineBehaviour
{
    Transform player;
    NavMeshAgent agent;
    ...
    public float atackingDistance = 10f;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        // --- Checking if the agent should Start Atack --- //

        if (distanceFromPlayer <= atackingDistance)
        {
