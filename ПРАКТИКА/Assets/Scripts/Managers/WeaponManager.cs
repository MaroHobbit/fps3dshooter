...
public class WeaponManager : MonoBehaviour
{
    ...
    public float throwMultiplier = 0;
    public float throwMultiplierLimit = 2f;

    [Header("Lethal")]
    private int lethalLimit = 100;
    public int lethalCount = 0;
    public Throwable.ThrowableType equippedLethalType;
    public GameObject grenadePrefab;

    [Header("Tactical")]
    private int tacticalLimit = 100;
    ...
    private void Update()
    {
        ...
        if (Input.GetKey(KeyCode.G) || Input.GetKey(KeyCode.T))
        {
            ...
            if (throwMultiplier > throwMultiplierLimit)
            {
                throwMultiplier = throwMultiplierLimit;
            }
        }
    ...
    private void ThrowLethal()
    {
        ...
        rb.AddForce(Camera.main.transform.forward * (throwForce * throwMultiplier), ForceMode.Impulse);
    ...
    private GameObject GetThrowablePrefab(Throwable.ThrowableType equippedGrenadeType)
    {
        switch (equippedGrenadeType)
        {
            case Throwable.ThrowableType.Grenade:
